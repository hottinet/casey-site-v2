...
export const NEXT_ROUTE_MAP: Record<string, string> = {
  [ZOLA_ONBOARDING]: ZOLA_NAVIGATION_ROUTE,
  [ZOLA_NAVIGATION_ROUTE]: ZOLA_BABY_ROUTE,
  [ZOLA_BABY_ROUTE]: ZOLA_BUDGET_ROUTE,
  [ZOLA_BUDGET_ROUTE]: CORE_PROGRAMS,
